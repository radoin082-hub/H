        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="registration.php" method="post">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" name="secondname" placeholder="Second Name (L3)">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" name="thirdname" placeholder="Third Name (L3)">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" name="fourthname" placeholder="Fourth Name (L3)">
                    </div>
                    <div class="mb-3">
            ...
            <div class="card-footer text-center">
                <p class="text-muted mb-0">Already Registered? <a href="login.php">Login Here</a></p>
            </div>
        </div>
    </div>
</body>
